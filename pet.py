# coding=utf-8 because ascii wasn't working on my Pycharm version.
# Make all import
...
No return just print
        ...
        talks = {
            'newborn': "Hi master, my name is {}.".format(self._name),
            'feed': "Yummy!",
            'drink': "Tasty drink ~",
...
# ######  talks = {
#            'default': 'I feel good.', 'hunger': 'I am so hungry ~',
...
No return
    """
    #  global 'Pet' variable assigned to fix issue down there.
    global Pet
    print("Welcome to this virtual pet game!")

    # error checking for user input
    while True:
        prompt = input("Please input the species (dog or cat), name, gender (male / female), fur color of your pet, "
    ...
    intro = "\nYou can let your pet eat, drink, get a shower, get some sleep, or play with him or her by entering " \
            "each of the following commands:\n --- [feed] [drink] [shower] [sleep] [play]\n You can also check the " \
            "health status of your pet by entering:\n --- [status]. "
    print(intro)
        ...
        if prompt == 'feed':
            ...
            while True:
                ...
                if quantity in true_list:
                    ...
                    print('Invalid input.')
            #  "Local variable 'Pet' might be referenced before assignment", so I added global up there.
            if type(Pet) == Cat:
